...
task main ()
{
  ...
  //the empty while loop is here so that the main task keeps going
  //if it wasn't here then it would just start the tasks and
  //then turn itself off which turns everything off
  while(true){}
}
