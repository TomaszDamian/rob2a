...
/*
	part two of 4, this code is responsible for the second part of what is supposed to happen.
	This is supposed to drive towards ball 2
*/
...
//crane down and claw closed is the initial position of the robot's arm
	...
	//you want to ignore them and just drive forward for about 1m
	Drive(BASEDIST*2, true);
